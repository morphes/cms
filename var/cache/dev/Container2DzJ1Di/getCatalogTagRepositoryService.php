...
// Returns the private 'App\Repository\CatalogTagRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CatalogTagRepository.php';

return $this->privates['App\Repository\CatalogTagRepository'] = new \App\Repository\CatalogTagRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
