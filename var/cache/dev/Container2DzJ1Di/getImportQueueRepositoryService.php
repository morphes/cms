...
// Returns the private 'App\Repository\ImportQueueRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ImportQueueRepository.php';

return $this->privates['App\Repository\ImportQueueRepository'] = new \App\Repository\ImportQueueRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
