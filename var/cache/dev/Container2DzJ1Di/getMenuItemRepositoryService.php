...
// Returns the private 'App\Repository\MenuItemRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/MenuItemRepository.php';

return $this->privates['App\Repository\MenuItemRepository'] = new \App\Repository\MenuItemRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
