...
include_once $this->targetDirs[3].'/src/DataFixtures/UrlFixture.php';
include_once $this->targetDirs[3].'/src/DataFixtures/UserFixture.php';
include_once $this->targetDirs[3].'/src/DataFixtures/UserProfileFixtures.php';

$a = new \Doctrine\Bundle\FixturesBundle\Loader\SymfonyFixturesLoader($this);

$b = ($this->services['security.password_encoder'] ?? $this->load('getSecurity_PasswordEncoderService.php'));

$a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\UrlFixture($b), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\UserFixture($b), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\UserProfileFixtures($b), 'groups' => []]]);
