...
// Returns the private 'App\Repository\ImportQueueRelationRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ImportQueueRelationRepository.php';

return $this->privates['App\Repository\ImportQueueRelationRepository'] = new \App\Repository\ImportQueueRelationRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
