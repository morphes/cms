...
// Returns the private 'App\Repository\CatalogUrlRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CatalogUrlRepository.php';

return $this->privates['App\Repository\CatalogUrlRepository'] = new \App\Repository\CatalogUrlRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
