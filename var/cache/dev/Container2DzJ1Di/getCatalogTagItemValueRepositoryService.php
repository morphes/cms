...
// Returns the private 'App\Repository\CatalogTagItemValueRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CatalogTagItemValueRepository.php';

return $this->privates['App\Repository\CatalogTagItemValueRepository'] = new \App\Repository\CatalogTagItemValueRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
