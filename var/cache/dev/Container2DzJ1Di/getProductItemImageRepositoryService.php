...
// Returns the private 'App\Repository\ProductItemImageRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ProductItemImageRepository.php';

return $this->privates['App\Repository\ProductItemImageRepository'] = new \App\Repository\ProductItemImageRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
