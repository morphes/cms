...
// Returns the private 'App\Repository\CatalogTagItemRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CatalogTagItemRepository.php';

return $this->privates['App\Repository\CatalogTagItemRepository'] = new \App\Repository\CatalogTagItemRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
