...
// Returns the private 'App\Repository\ProductTagValueRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ProductTagValueRepository.php';

return $this->privates['App\Repository\ProductTagValueRepository'] = new \App\Repository\ProductTagValueRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
