...
// Returns the private 'doctrine.orm.lp_perl_entity_manager.property_info_extractor' shared service.
...
return $this->privates['doctrine.orm.lp_perl_entity_manager.property_info_extractor'] = new \Symfony\Bridge\Doctrine\PropertyInfo\DoctrineExtractor(($this->services['doctrine.orm.lp_perl_entity_manager'] ?? $this->load('getDoctrine_Orm_LpPerlEntityManagerService.php'))->getMetadataFactory());
