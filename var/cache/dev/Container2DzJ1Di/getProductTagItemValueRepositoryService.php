...
// Returns the private 'App\Repository\ProductTagItemValueRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ProductTagItemValueRepository.php';

return $this->privates['App\Repository\ProductTagItemValueRepository'] = new \App\Repository\ProductTagItemValueRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
