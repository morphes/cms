...
// Returns the private 'App\Repository\SaleRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/SaleRepository.php';

return $this->privates['App\Repository\SaleRepository'] = new \App\Repository\SaleRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
