...
// Returns the private 'App\Repository\UrlsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/UrlsRepository.php';

return $this->privates['App\Repository\UrlsRepository'] = new \App\Repository\UrlsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
