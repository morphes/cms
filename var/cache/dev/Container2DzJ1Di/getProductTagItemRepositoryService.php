...
// Returns the private 'App\Repository\ProductTagItemRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ProductTagItemRepository.php';

return $this->privates['App\Repository\ProductTagItemRepository'] = new \App\Repository\ProductTagItemRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
