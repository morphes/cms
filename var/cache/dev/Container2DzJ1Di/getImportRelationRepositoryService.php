...
// Returns the private 'App\Repository\ImportRelationRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ImportRelationRepository.php';

return $this->privates['App\Repository\ImportRelationRepository'] = new \App\Repository\ImportRelationRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
