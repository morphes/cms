...
// Returns the private 'App\Repository\ImportProductRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ImportProductRepository.php';

return $this->privates['App\Repository\ImportProductRepository'] = new \App\Repository\ImportProductRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
