...
// Returns the private 'App\Repository\ProductTagRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ProductTagRepository.php';

return $this->privates['App\Repository\ProductTagRepository'] = new \App\Repository\ProductTagRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
