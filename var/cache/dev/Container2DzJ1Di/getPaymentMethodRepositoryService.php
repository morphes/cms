...
// Returns the private 'App\Repository\PaymentMethodRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PaymentMethodRepository.php';

return $this->privates['App\Repository\PaymentMethodRepository'] = new \App\Repository\PaymentMethodRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
