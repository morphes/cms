...
// Returns the private 'App\Repository\ProductItemRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ProductItemRepository.php';

return $this->privates['App\Repository\ProductItemRepository'] = new \App\Repository\ProductItemRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
