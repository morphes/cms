...
// Returns the private 'App\Repository\BasketItemRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/BasketItemRepository.php';

return $this->privates['App\Repository\BasketItemRepository'] = new \App\Repository\BasketItemRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
