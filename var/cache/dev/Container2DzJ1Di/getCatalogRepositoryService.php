...
// Returns the private 'App\Repository\CatalogRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CatalogRepository.php';

return $this->privates['App\Repository\CatalogRepository'] = new \App\Repository\CatalogRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
