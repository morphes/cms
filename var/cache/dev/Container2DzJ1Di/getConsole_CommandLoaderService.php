...
return $this->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\ServiceLocator(['App\\Command\\ImportProductCommand' => function (): \App\Command\ImportProductCommand {
    return ($this->privates['App\Command\ImportProductCommand'] ?? $this->load('getImportProductCommandService.php'));
}, 'App\\Command\\MigrateCommand' => function (): \App\Command\MigrateCommand {
    return ($this->privates['App\Command\MigrateCommand'] ?? $this->load('getMigrateCommandService.php'));
