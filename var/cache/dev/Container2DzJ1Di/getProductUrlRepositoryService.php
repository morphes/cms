...
// Returns the private 'App\Repository\ProductUrlRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ProductUrlRepository.php';

return $this->privates['App\Repository\ProductUrlRepository'] = new \App\Repository\ProductUrlRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
