...
class __TwigTemplate_320520c390236c9e2d96ee61fb654cf54281d5f554a19c96fcf9d93c54cda84f extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<script src=\"";
        // line 8
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl((("bundles/easyadmin/javascript/select2/i18n/" . (isset($context["_select2_locale"]) || array_key_exists("_select2_locale", $context) ? $context["_select2_locale"] : (function () { throw new RuntimeError('Variable "_select2_locale" does not exist.', 8, $this->source); })())) . ".js")), "html", null, true);
        echo "\"></script>
...
\$(function() {
    ...
    \$('#main').find('form select[data-widget=\"select2\"]').select2({
        ...
        language: '";
        // line 15
        echo twig_escape_filter($this->env, (isset($context["_select2_locale"]) || array_key_exists("_select2_locale", $context) ? $context["_select2_locale"] : (function () { throw new RuntimeError('Variable "_select2_locale" does not exist.', 15, $this->source); })()), "html", null, true);
        echo "'
    });
});
</script>
";
    ...
    {
        return array (  64 => 15,  54 => 8,  51 => 7,  49 => 5,  48 => 4,  47 => 3,  45 => 2,  43 => 1,);
    }
...
", "@EasyAdmin/default/includes/_select2_widget.html.twig", "/var/www/symfony/vendor/easycorp/easyadmin-bundle/src/Resources/views/default/includes/_select2_widget.html.twig");
    }
}
