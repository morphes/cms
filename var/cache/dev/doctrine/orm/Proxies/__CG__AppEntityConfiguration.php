...
class Configuration extends \App\Entity\Configuration implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Configuration' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Configuration' . "\0" . 'option', '' . "\0" . 'App\\Entity\\Configuration' . "\0" . 'value'];
        }
     ...
     * {@inheritDoc}
     */
    public function setOption(?string $option): \App\Entity\Configuration
    {
